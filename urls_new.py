...
# Ensure MAM and investment related views are explicitly available
from .views.views3 import (
...
api_patterns = [
    ...
    # Ticket endpoints
    path('tickets/create/', CreateTicketView.as_view(), name='api-create-ticket'),  # POST: create new ticket
    path('tickets/my-tickets/', UserTicketsView.as_view(), name='api-user-tickets'),  # GET: user's tickets
    ...
    # IB status API (used by frontends that call /client/api/ib/status/)
    path('ib/status/', IBStatusView.as_view(), name='api-ib-status'),
    path('ib/stats/', IBStatsOverviewView.as_view(), name='ib-stats'),
    path('ib/client-tree/', IBClientTreeView.as_view(), name='api-ib-client-tree'),
    path('ib/commission-transactions/', IBCommissionTransactionsView.as_view(), name='api-ib-commission-transactions'),
    path('ib/transactions/', IBTransactionsView.as_view(), name='api-ib-transactions'),
    path('ib/request-withdrawal/', RequestWithdrawalView.as_view(), name='api-ib-request-withdrawal'),
    path('ib/add-client/', IBAddClientView.as_view(), name='api-ib-add-client'),
    path('ib/commission-balance/', IBCommissionBalanceView.as_view(), name='api-ib-commission-balance'),
    ...
    path('user-investments/', UserInvestmentsView.as_view(), name='user-investments'),
    path('pause-copying/', PauseCopyingView.as_view(), name='pause-copying'),
...
urlpatterns = [
    ...
    # Also accept `/client/`-prefixed paths used by some frontends or proxies
    path('client/ib/status/', IBStatusView.as_view(), name='client-ib-status'),
    path('client/ib/stats/', IBStatsOverviewView.as_view(), name='client-ib-stats'),
